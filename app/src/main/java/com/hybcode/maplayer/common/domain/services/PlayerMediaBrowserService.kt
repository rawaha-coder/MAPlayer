...
import com.hybcode.maplayer.common.domain.services.Constants.START_MEDIA_PLAY_ACTION
...
class PlayerMediaBrowserService : MediaBrowserServiceCompat() {
    ...
    override fun onCreate() {
        ...
        mediaSessionConnector = MediaSessionConnector(mediaSession).apply {
            setPlaybackPreparer(SongMediaPlayBackPreparer())
    ...
    inner class SongMediaPlayBackPreparer :
        ...
        override fun onPrepareFromMediaId(
            ...
            mediaSource.whenReady {
                ...
                val itemToPlay = mediaSource.songMediaMetaData.find {
                ...
                preparePlayer(
                    mediaMetadata = mediaSource.songMediaMetaData,
    ...
    inner class MediaQueueNavigator(mediaSessionCompat: MediaSessionCompat
        ...
        override fun getMediaDescription(
            ...
            if (windowIndex < mediaSource.songMediaMetaData.size) {
                return mediaSource.songMediaMetaData[windowIndex].description
            }
